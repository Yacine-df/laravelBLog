...
<div class="bg-white p-8 rounded-md w-full">
    <div class=" flex items-center justify-between pb-6">
        <div>
            <h2 class="text-gray-600 font-semibold">My Posts</h2>
        </div>
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    ...
                                    @else
                                        ...
                                        class="relative inline-block px-3 py-1 font-semibold text-red-900 leading-tight">
                                            ...
                                            <span class="relative">Unactive</span>
                                        </span>
                                    @endif
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <button class="bg-blue-500 hover:bg-blue-400 px-2 py-1 m-1 text-white rounded-xl w-16"><a href="/dashboard/post/{{$post->id}}/edit">Edit</a></button>
